...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../FloatingPointMultiplication.srcs/sources_1/bd/design_1/ipshared/4fba" \
       +incdir+"../../../../FloatingPointMultiplication.srcs/sources_1/bd/design_1/ipshared/4fba"
}
