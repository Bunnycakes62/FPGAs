...
HD_PWD='C:/Users/17073/Desktop/FPGA/digitalClock/digitalClock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log time_disp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source time_disp.tcl -notrace
