...
HD_PWD='C:/Users/17073/Desktop/FPGA/digitalClock/digitalClock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log time_disp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source time_disp.tcl
