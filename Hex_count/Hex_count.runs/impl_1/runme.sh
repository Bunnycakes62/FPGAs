...
HD_PWD='C:/Users/17073/Desktop/FPGA/Hex_count/Hex_count.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hex_count.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hex_count.tcl -notrace
