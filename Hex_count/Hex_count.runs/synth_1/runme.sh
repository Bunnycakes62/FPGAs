...
HD_PWD='C:/Users/17073/Desktop/FPGA/Hex_count/Hex_count.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hex_count.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hex_count.tcl
